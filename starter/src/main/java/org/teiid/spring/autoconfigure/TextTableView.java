...
public class TextTableView extends ViewBuilder<TextTable> {
    ...
    void onFinish(Table view, MetadataFactory mf, Class<?> entityClazz, TextTable annotation) {
        ...
        sb.append("FROM (EXEC ").append(source).append(".getTextFiles('").append(file).append("')) AS f, ").append("\n");
    ...
    @Override
    void onColumnCreate(Table view, Column column, MetadataFactory mf, Field field, boolean last, TextTable annotation) {
